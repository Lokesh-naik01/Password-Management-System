...
router.get('/',checkLoginUser,function(req,res,next){
  ...
  var getDetails=passModel.find({user:req.session.userName});
  getDetails.exec(function(err,data){
    ...
    {
      res.render('view-all-password', { title: 'Password Management System',loginUser:req.session.userName,records: data});
    }
  });
});
